        ...
        <div v-else class="template-list">
          <div v-for="t in templates" :key="t.id" class="template-card">
            ...
            <div class="template-actions">
              ...
              <button @click.stop="supprimerTemplate(t)" class="btn-delete">🗑️ Supprimer</button>
            </div>
          </div>
        </div>
      </article>
...
.btn-delete {
  ...
  background: #fef2f2; color: #dc2626; font-weight: 600; cursor: pointer; font-size: 13px; transition: all 0.15s;
}
